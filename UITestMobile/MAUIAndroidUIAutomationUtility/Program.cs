...
class Program
{
    static void Main()
    {
        ...
        //Android platform
        new Dictionary<string, string> { { "ProjectName", "maui-scheduler-tests" }, { "SampleName", "SfSchedulerAppointmentTemplate" }, { "ApplicationID", "com.companyname.sfschedulerappointmenttemplate" }, { "Platform", "UITests.Android" }, { "EmulatorCommand", "Pixel_2_XL" } },
        ...
        //iOS platform
        //new Dictionary<string, string> { { "ProjectName", "maui-scheduler-tests" }, { "SampleName", "SfSchedulerAppointmentTemplate" }, { "ApplicationID", "com.companyname.sfschedulerappointmenttemplate" }, { "Platform", "UITests.iOS" }, { "EmulatorCommand", "97EC2C85-8AD6-4221-9B2D-7743040654D4" } },
        //new Dictionary<string, string> { { "ProjectName", "maui-scheduler-tests" }, { "SampleName", "SfSchedulerCalendarTypes" }, { "ApplicationID", "com.companyname.sfschedulercalendartypes" }, { "Platform", "UITests.iOs" }, { "EmulatorCommand", "97EC2C85-8AD6-4221-9B2D-7743040654D4" } },
